...
def fix_me():
    ...
    for radius in range(1,3): 
        Emvado_Perifereia_Kuklou(radius)
    for side in range(1,6,4):
        Emvado_Perifereia_Trigonou(side)

def Emvado_Perifereia_Kuklou(r):
    from math import pi
    print("Emvado kyklou aktinas", r, "=", pi*r**2, "me perifereia", 2*pi*r)
    
def Emvado_Perifereia_Trigonou(x):
    print("Emvado isoskelous or8ogwniou trigwnou me ka8eti pleura", x, "=", (1/2)*(x**2) ,"me perifereia", "=", (2+sqrt(2))*x )